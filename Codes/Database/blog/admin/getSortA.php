<?php
	...
	if(isset($_POST['user_name'])){
		...
		$query = $db->prepare("SELECT post_id, user_id, title, body,category_id, posted, uVote, dVote, EditDate, subsaidit, subID FROM posts WHERE user_id = '$var' ORDER BY uVote - dVote DESC");
		$query->execute();
